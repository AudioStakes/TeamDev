...
:setvar DefaultDataPath "C:\Users\harp179\AppData\Local\Microsoft\Microsoft SQL Server Local DB\Instances\MSSQLLocalDB"
:setvar DefaultLogPath "C:\Users\harp179\AppData\Local\Microsoft\Microsoft SQL Server Local DB\Instances\MSSQLLocalDB"
...
ELSE
    BEGIN
        PRINT N'データベースの設定を変更できません。これらの設定を適用するには、SysAdmin であることが必要です。';
    END
