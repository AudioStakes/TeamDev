...
namespace NotObjectOrientedSample
{
    ...
    public static class OpendWindows
    {
        ...
        private static Dictionary<MainWindow, MainWindow> mappingChildToParent = new Dictionary<MainWindow, MainWindow>();
        ...
        public static void OpenNewChild(MainWindow parent)
        {
            ...
            list.Add(w);
            OpendWindows.mappingChildToParent.Add(w, parent);
            w.Show();
        }
        ...
        public static void CloseParent(MainWindow child)
        {
            if(OpendWindows.mappingChildToParent.ContainsKey(child))
            {
                var parent = OpendWindows.mappingChildToParent[child];
                OpendWindows.mappingChildToParent.Remove(child);
                parent.Close();
            }
